    ...
    <footer className={styles.footer}>
      ...
      N.S.A History
        ...
        <div className={styles.section}>
          <h3>Contact</h3>
          <ul>
            <li className={styles.branches}>nonistudents@gmail.com</li>
            <li className={styles.branches}>+237 671 342 844</li>
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126886.1119571692!2d10.507973957664973!3d6.3693234898740885!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1058aa3b91178ec9%3A0x3a23dbe24cf4fd1e!2sNoni!5e0!3m2!1sen!2scm!4v1710042943012!5m2!1sen!2scm"  style={{border:0, height:"200px", width:"1200px", marginLeft:"-57px"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" className={styles.map}></iframe>
      </section>
